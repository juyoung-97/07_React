// JSX 예제
import test1 from "../assets/20260102144434_00001.webp";
...
// JSX 예제 4 : 로그인 여부에 따라 하ㅗ면 다르게 보이기 (삼항 연산자)
const Exam5_4 = ()=> {
    // JS 영역 -> if-else 사용 가능
    // JSX 영역 -> 삼항연산자 사용
    return  <h1>{true ? '환영' : '로그인해'}</h1>
}

// JSX 예제 5  : 배열을 이용한 화면 렌더링 방법 (***중오 : 자주사용!!!***)
...
const Exam5_5 = () => {
    ...
    // 새로운 배열을 만들어 반환 -> map
    const listItem = members.map((member) => <li>{member}</li>);
